...
tasks = ['GETSTATS', 'LGC2HMP', 'LGC2MTX', 'LGC2FJK', 'F1CHECK', 'CONSENSUS', 'RENAMESAMPLE']
# MAPSEP = "\t"
# NEWLINE = "\n"
# SPACE = " "
# GRIDSEP = ","
...
if task == "F1CHECK":
    ...
    writePurityTable(outPrefix + "_" + "Puritytable.csv", parentMap, consensusOutData, markerIDs)
